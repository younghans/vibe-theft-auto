...
- Mixamo-derived characters, animations, and portraits are bundled as runtime
  project assets only. Do not treat them as ISC-licensed assets, and do not reuse
  them outside this project unless you independently comply with Adobe/Mixamo
  terms.

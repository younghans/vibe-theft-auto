...
export const assets = {
  playerAnimationSet: {
    ...
    rightHook: 'rightHook',
    uppercut: 'uppercut',
    hitReactions: Object.freeze(['headHit', 'stomachHit']),
    snatch: 'snatch',
    drunkIdle: 'drunkIdle',
    drunkWalk: 'drunkWalk',
  ...
  mixamo: {
    ...
    animations: {
      ...
      rightHook: assetUrl('mixamo', 'animations', 'right-hook.json'),
      uppercut: assetUrl('mixamo', 'animations', 'uppercut.json'),
      headHit: assetUrl('mixamo', 'animations', 'head-hit.json'),
      stomachHit: assetUrl('mixamo', 'animations', 'stomach-hit.json'),

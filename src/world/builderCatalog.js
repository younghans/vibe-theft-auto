...
const CITY_TILE_DEFINITIONS = Object.freeze([
  ...
  ...CUSTOM_2X2_BUILDING_DEFINITIONS,
  {
    ...
    collision: true,
    blocksShots: true,
    movementCollisionRects: HOSPITAL_COLLISION_RECTS,
    shotCollisionRects: HOSPITAL_COLLISION_RECTS,
    padding: 0.5,
    underlayTileId: BUILDING_UNDERLAY_TILE_ID
  },
  {
  ...
  },
  {
    ...
    collision: true,
    blocksShots: true,
    movementCollisionRects: HOSPITAL_WIDE_COLLISION_RECTS,
    shotCollisionRects: HOSPITAL_WIDE_COLLISION_RECTS,
    padding: 0.5,
    underlayTileId: BUILDING_UNDERLAY_TILE_ID
  },
  {
...
const CITY_PROP_DEFINITIONS = Object.freeze([
  {
    id: 'sidewalk',
    assetName: 'sidewalk',
    aliases: ['Sidewalk', 'concrete walkway', 'pavement path'],
    label: 'Sidewalk',
    asset: null,
    group: 'street',
    ...
    createVisual: createSidewalkPropVisual
  },
  {
    id: 'stone_path',
    assetName: 'stone_path',
    aliases: ['Stone Path', 'stone walkway', 'paver path'],
    label: 'Stone Path',
    asset: null,
    group: 'street',
    ...
    blocksShots: false,
    groundClearance: 0.018,
    createVisual: createStonePathPropVisual
  },
  {
    id: 'dirt_path',
    assetName: 'dirt_path',
    aliases: ['Dirt Path', 'dirt walkway', 'trail path'],
    label: 'Dirt Path',
    asset: null,
    group: 'street',
    ...
    blocksShots: false,
    groundClearance: 0.018,
    createVisual: createDirtPathPropVisual
  },

...
const SCHOOL_SKETCH_GUESSR_SKETCHES = Object.freeze([
  ...
  freezeSketch({
    ...
    aliases: ['cap'],
    strokes: [
      { d: 'M22 59 C32 53 68 53 78 59 C84 63 80 70 70 70 L30 70 C20 70 16 63 22 59' },
      { d: 'M34 58 C36 36 64 36 66 58' },
      { d: 'M36 47 C43 52 57 52 64 47' },
      { d: 'M31 61 C43 65 57 65 69 61' },
      { d: 'M66 58 C75 58 84 61 91 66 C82 69 74 69 68 66' }
    ]
  }),
  freezeSketch({
    id: 'lamp',
  ...
  freezeSketch({
    ...
    aliases: ['pen'],
    strokes: [
      { d: 'M22 71 L61 32 L74 45 L35 84 Z' },
      { d: 'M61 32 L68 20 L80 13 L74 45' },
      { d: 'M68 20 L80 32' },
      { d: 'M22 71 L16 84 L35 84' },
      { d: 'M29 64 L42 77 M55 38 L68 51' },
      { d: 'M20 76 L29 85' }
    ]
  })
]);

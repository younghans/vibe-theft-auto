...
const OFFICE_JOB_DEFINITIONS = Object.freeze([
  ...
  Object.freeze({
    ...
    description: 'Time each sliding executive memo through varied approval windows.',
    prompt: 'Stamp three memos cleanly as the paper slides out and back. One bad stamp tanks the quarter.',
    instructions: 'Press Spacebar or click Stamp when the sliding memo is inside the approval window.',

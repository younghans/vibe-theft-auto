...
const OFFICE_JOB_DEFINITIONS = Object.freeze([
  Object.freeze({
    ...
    shortTitle: 'Janitor',
    tier: 1,
    subtitle: 'Sink three paper toss rounds through the fan.',
    description: 'Paper toss three crumpled reports into the basket while the desk fan gets stronger.',
    prompt: 'Land three clean throws. Each round has tighter timing and meaner fan drift.',
    eyebrow: 'Office Job',
    rewardMoney: 25,
    rewardXp: 0,
